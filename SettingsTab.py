...
class SettingsTab(QTabWidget):
    ...
    def create_form_groupbox(self):
        ...
        self.lineedit_learning_rate = QLineEdit()
        self.lineedit_batch_size = QLineEdit()
        ...
        layout.addRow(QLabel())
        layout.addRow(QLabel("Learning Rate:"))
        layout.addRow(self.lineedit_learning_rate)
        layout.addRow(QLabel("Batch Size:"))
        layout.addRow(self.lineedit_batch_size)
    ...
    def read_settings(self):
        ...
        self.lineedit_learning_rate.setText(str(self.settings.get_learning_rate()))
        self.lineedit_batch_size.setText(str(self.settings.get_batch_size()))
    ...
    def save_settings(self):
        ...
        self.settings.set_learning_rate(self.lineedit_learning_rate.text())
        self.settings.set_batch_size(self.lineedit_batch_size.text())
